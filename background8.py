...
def next3():
    ...
    ga_img1 = PhotoImage(file = "./photos/가/size/가지.png")
    ga_img2 = PhotoImage(file = "./photos/가/size/가방.png")
    ga_img3 = PhotoImage(file = "./photos/가/size/가위.png")

    
    my_canvas.create_image(300,310,image = ga_img1)
    my_canvas.create_image(650,310,image = ga_img2)
    my_canvas.create_image(1000,310,image = ga_img3)
